...
class TestMarsRover(unittest.TestCase):
    ...
    def test_move_on_x(self):
        mars_rover = create_mars_rover_agg(actual_point=Point.create(0, 0, Direction.EAST))
        mars_rover.move()
        mars_rover.move()
    ...
    def test_move_on_y(self):
        mars_rover = create_mars_rover_agg(actual_point=Point.create(0, 0, Direction.WEST))
        mars_rover.move()
        mars_rover.move()
